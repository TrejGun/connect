...
describe("#GOOGLE API", () => {
    ...
    describe("deleteEvent", () => {
        ...
        it("deleteEvent with valid event", (done) => {
            ...
            GAPI.getEvent(event)
                ...
                .then(() => {
                    return GAPI.deleteEvent(err, event);
                });
        });
    ...
    after("Delete all calendars", () => {
        return asyncq.mapLimit(operators, 5, oper => {
                return delay(5000)
                    .then(() => {
